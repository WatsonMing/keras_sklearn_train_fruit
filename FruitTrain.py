...
class DataSet(object):
    ...
    def extract_data(self,train_path):
        ...
        #print("Get Fruit Image Data:",labels)
...
class Model(object):
    FILE_PATH = "Model/fruit.model.h5"
    IMAGE_SIZE = 128
    def __init__(self):
        self.model = None
    ...
    def train(self,dataset):
        ...
        self.model.fit(dataset.X_train, dataset.Y_train, epochs=20, batch_size=32, )
...
def train():
    dataset = DataSet()
    dataset.extract_data("Binaryzation_Image/")#构建模型的图片库
